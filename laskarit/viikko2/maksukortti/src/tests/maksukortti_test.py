...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_negatiivisen_summan_lataaminen_ei_muuta_kortin_sisaltoa(self):
        self.kortti.lataa_rahaa(-10)
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa")

    def test_kortilla_voi_maksaa_edullisen_lounaan_kun_kortilla_on_rahaa_vain_edullisen_lounaan_verran(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
    ...
    def test_kortilla_voi_maksaa_maukkaan_lounaan_kun_kortilla_on_rahaa_vain_maukkaan_lounaan_verran(self):
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
