...
Sizes and scales are in some cases related to application functionality so in case of any change test thoroughly.
"""
...
VERTICAL_SPACE_PER_FOURTH_NOTE = 55 
...
BREAK_SIGNS = {4: os.path.join(parent, "graphics/-2.png"), 8: os.path.join(parent, "graphics/-1.png")}
